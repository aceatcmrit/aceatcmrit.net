				...
				<div id="left">
					<div>
						...
						<div id="intro">
							<?php
							$dir = dir("./speakers");
							//List files in speakers directory
							while (($file = $dir -> read()) !== false) {
								if ($file != '.' && $file != '..') {
									echo "<div><h3>";
									echo "<img  width='150' style='float:right' src='./speakers/" . $file . "/img.jpg'>";
									echo "<br/>" . $file;

									echo "</h3><p>";

									$descFile = "./speakers/" . $file . "/desc.txt";
									$descData = fopen($descFile, 'r');

									$count = 0;
									while ($count < filesize($descFile) - 1) {	$char = fread($descData, 1);
										if ($char == "\n")
											echo "<br/>";
										else
											echo $char;
