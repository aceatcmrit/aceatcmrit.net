...
function getPoll($pollID) {
	...
	while ($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
		...
		if ($pollStartHtml == '') {
			...
			$pollEndHtml = '</ul><input type="submit" name="pollSubmit" id="pollSubmit"  action="./poll/ajax-poll/inc/functions.php?action=vote" value="Vote" /> <span id="pollMessage"></span><img src="./img/ajaxLoader.gif" alt="Ajax Loader" id="pollAjaxLoader" /></form></div>';
		}
